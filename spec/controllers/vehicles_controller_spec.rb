  ...
  describe '#update' do
    ...
    context 'when authorized' do
       ...
       describe '#destroy' do
        ...
        subject { delete :destroy, params: { id: vehicle.id } }
        ...
        context 'when trying to remove not owned vehicle' do
          let(:other_user) { create :user }
          let(:other_vehicle) { create :vehicle, user: other_user }

          subject { delete :destroy, params: { id: other_vehicle.id } }
          before { request.headers['authorization'] = "Bearer #{access_token.token}" }
        ...
        context 'when authorized' do
          ...
          context 'when success request sent' do
            ...
            it 'should destroy the vehicle' do
              vehicle
